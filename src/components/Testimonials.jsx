            ...
            <Slider {...settings}>
              {testimonialData.map(({ id, name, text, img }) => (
                <div key={id} className="my-6">
                  <div
                    className="flex flex-col sm:flex-row gap-5 md:gap-14 p-4 mx-4 rounded-xl 
                  ...
                  >
                    ...
                    <p className="text-black/10 text-[12rem] font-serif absolute bottom-0 right-0 dark:text-white/80">
                      ,,
                    </p>
                  </div>
                </div>
